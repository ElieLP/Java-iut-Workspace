...
public class Interaction {
	...
	private void placerBateau(int numJoueur, String nomBateau, int tailleBateau) {
		...
		while (!place) {
			...
			System.out.println("O� souhaitez-vous positionner votre "
					+ nomBateau + "?");
			System.out.println("Donnez les coordonnees de la premiere case : ");
			...
			//TODO ligne ci-dessous a effacer durant la seance de TP en classe
			place = true;
		}
